...
(function()
{
	...
	CKEDITOR.plugins.add( plugin_name,
	{
		...
		{
			var req = 'em' /* tag */ + '[!data-plugin,!width,!height]' /* attrs */ +'(' + result_class + ')' /* classes */ +'{width,height}' /* styles */;
			
			editor.addCommand(command, new CKEDITOR.dialogCommand(command,{allowedContent: req}));
			...
			editor.on( 'doubleclick', function( e )
			{
				...
				if( element.is('img') && element.data('cke-real-element-type') === obj_kind )
				{
