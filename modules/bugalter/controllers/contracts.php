...
$core->tpl->assign('contragents',$root->getContragentsReference());
$core->tpl->assign('contractStatuses',$root->getContractStatuses());
$core->tpl->assign('contractsCategories',$root->getContractCategories());
