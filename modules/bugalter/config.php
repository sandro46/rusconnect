...
$core->modules->add_controller('invoices', 'contracts', 'companies', 'bank', 'persons', 'updatebic', 'thelist');
$core->modules->add_default_controller('invoices');
