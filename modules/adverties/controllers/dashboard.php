...
$core->ajax->register($crm, 'getContacts', 1);
$core->ajax->register($crm, 'getContactsOnlyId', 1);
$core->ajax->listen();

$core->tpl->assign('campaignStatuses', $api->getCampaignStatuses());
$core->tpl->assign('campaignTypes', $api->getCampaignTypes());
$core->tpl->assign('myUsers', $crm->getClientUsers());
