...
$core->modules->this['menu'][]= array('controller' => 'dashboard' , 'name'=>'Кампании', 'action_id'=>1);
...
$core->modules->add_controller('dashboard');
$core->modules->add_default_controller('dashboard');
