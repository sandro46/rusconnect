...
$core->modules->add_controller('show', 'add', 'list');
...
if(!$core->is_admin()){
// 	require_once('classes/admin.catalog.php');
// 	$core->shop = new admin_catalog();
	
	//$core->lib->load('clients_shop');
	//$core->shop = new clients_shop();
}
