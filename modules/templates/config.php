...
//$core->modules->this['menu'][]= array('controller' => 'list' , 'name'=>'Список шаблонов', 'action_id'=>1);
//$core->modules->this['menu'][]= array('controller' => 'add' , 'name'=>'Новый шаблон', 'action_id'=>5);
//$core->modules->this['menu'][]= array('controller' => 'style' , 'name'=>'Стили', 'action_id'=>1);
//$core->modules->this['menu'][]= array('controller' => 'browse' , 'name'=>'Кэш', 'action_id'=>22);


$core->modules->this['controllers_path']= 'controllers/';


$core->modules->add_controller('list', 'add', 'del', 'edit', 'compil', 'save', 'style', 'browse', 'del_compil', 'history','rollback','preview', 'new_list');
