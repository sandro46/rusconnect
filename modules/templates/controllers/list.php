...
if($core->site_type == 2) {
	...
	$this->core->edit_site = $shop->shopId;
	$_SESSION['templates_site_id'] = $shop->shopId;
	$site_id = $shop->shopId;
} else {
	$site_id = (isset($_SESSION['templates_site_id']))? $_SESSION['templates_site_id'] : $core->edit_site;
}

//$core->history->add('mcms_tmpl', array(array('id_template', 'id_lang'), array(652, 1)), 'edit');
//$core->history->rollback(2);
//die('dddd');
...
$core->ajax->register($root,'save',1);
$core->ajax->register($root,'rollback',1);
$core->ajax->listen();
