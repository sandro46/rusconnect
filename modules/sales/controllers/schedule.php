...
$controller->load('admin.sales.php');
$controller->load('ajax.php');
$root = new admin_sales();

$core->tpl->assign('clients', $root->get_clients_list());
$core->tpl->assign('events_types', $root->get_events_types());
$core->tpl->assign('events', $root->get_events(1, false, 0, 9999999, 'state', 'desc'));
$core->tpl->assign('eventsResult', $root->eventsResult());
$core->tpl->assign('regions', $root->get_regions());
$core->tpl->assign('cientTypes', $root->get_clients_type());
$core->tpl->assign('managers', $root->get_managers(1));
...
$ajax->add_func('add_event','updateTimeEvent', 'get_event', 'getAllEvents', 'done_event', 'add_client', 'saveEvent', 'getClientInfo', 'getClients', 'getClientsTypes', 'getEventsTypes', 'getRegions');
$ajax->init();
