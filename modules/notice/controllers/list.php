...
$controller->load('notifications_admin.php');

$api = new notifications_admin();
$api->init();

$core->lib->loadModuleFiles('users', 'admin.users.php');
$users = new admin_users();
$users->init();


$core->ajax->register($users, 'getUsersList');
$core->ajax->register($users, 'getAccessGroups');
$core->ajax->register($api->notice, 'test');
