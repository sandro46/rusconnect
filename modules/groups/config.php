...
//$core->modules->this['menu'][]= array('controller' => 'list' , 'name'=>'Список групп', 'action_id'=>1);
//$core->modules->this['menu'][]= array('controller' => 'add' , 'name'=>'Добавить группу', 'action_id'=>5);
$core->modules->this['controllers_path']= '/controllers/';


$core->modules->add_controller('list', 'add', 'del', 'edit', 'save', 'show');
