...
if(!isset($_GET['type']) || ($_GET['type'] != 'album' && $_GET['type'] != 'image'))
{
	$controller->redirect('/'.$core->CONFIG['lang']['name'].'/photogallery/list/', 'Куда полез?.<br>');
}
...
$controller->redirect('/'.$core->CONFIG['lang']['name'].'/photogallery/list/', 'All data saved.<br>');
