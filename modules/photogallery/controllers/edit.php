...
if(!$id) $controller->redirect('/'.$core->CONFIG['lang']['name'].'/photogallery/list/', 'Bad Request.<br>');
...
$core->tpl->assign('Album', $root->get_album_info($id));

$core->lib->load('ajax');
$ajax = new ajax();
$ajax->debug_mode = 0;
$ajax->request_type = 'POST';
$ajax->add_func('upload_album_cover');
$ajax->init();
