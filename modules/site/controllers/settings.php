...
$controller->load('admin.site.php');
$api = new admin_site();
$api->init();

$controller->load('whois.php');
$ws = new Whois();
$ws->init($controller->include_url.'whois.servers.json');


$core->ajax->register($api,'methods'); 
$core->ajax->register($ws,'isAvailable');
$core->ajax->listen();

$core->tpl->assign('menuList', $api->getMenuList());
