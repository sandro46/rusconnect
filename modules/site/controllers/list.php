...
$controller->load('sites.php');


$controller->load('admin.catalog.php', 'catalog');
$cat = new admin_catalog();

$controller->load('client.shop.php', 'shop');
$shop = new client_shop();
$shop->init();

$api = new sites();
$api->init();

$api->addCatalogApi($cat);
$api->addShopApi($shop);
...
$subdomain = (strpos($core->user->login, '@') !== false)? substr($core->user->login, 0, strpos($core->user->login, '@')) : $core->user->login;
$core->tpl->assign('subdomainForStart', $subdomain);
$core->tpl->assign('clientCompanyInfo', $buh->getCompanyInfo($api->companyId));
