...
$core->modules->this['menu'][]= array('controller' => 'list' , 'name'=>'Список сайтов', 'action_id'=>1);
...
$core->modules->add_controller('list', 'create', 'test');
$core->modules->add_default_controller('menu');
