...
$core->ajax->register($api, 'deleteCupon', 1);
$core->ajax->register($api, 'isRootCompany', 1);
$core->ajax->listen();

$core->tpl->assign('CuponCategories',$api->getCuponCategories());
$core->tpl->assign('contragents',$buh->getContragentsReference());
$core->tpl->assign('RegionList',$api->getCityList());
