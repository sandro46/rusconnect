...
$controller->init();
$controller->tpl = 'users.main.html';
$controller->cached();

$controller->load('translate.php');
$api = new translate();

$core->tpl->assign('subtitle', 'Пользователи');

$core->ajax->register($api, 'getUsersList');
$core->ajax->register($api, 'saveUser');
$core->ajax->register($api, 'getUserInfo');
$core->ajax->register($api, 'deleteUser');
