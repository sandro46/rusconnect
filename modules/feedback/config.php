...
$core->modules->add_controller('list', 'del', 'send', 'show');
...
ini_set("SMTP","smtp.hoster.ru" );
ini_set('sendmail_from', 'info@m-cms.org'); 
//ini_set('auth_username', 'info@m-cms.org');
//ini_set('auth_password', 'QzWx123-');
