...
$controller->load('client.presscenter.php');
$root = new client_presscenter();

if(isset($_GET['id']))
{
    $core->tpl->assign ('entry', $root->get_entry($_GET['id'],false));
    $core->tpl->assign ('type', 'post');
    
}elseif(isset($_GET['comment'])){
    $core->tpl->assign ('entry', $root->get_comment($_GET['comment']));
    $core->tpl->assign ('type', 'comment');
}



if(isset($_POST['save'])){
    $root->create_comment($_POST['text'], $_POST['post_id']);
}
