...
$core->modules->this['menu'][]= array('controller' => 'list' , 'name'=>'Структура сайта', 'action_id'=>1);
#$core->modules->this['menu'][]= array('controller' => 'add' , 'name'=>$core->utf8('�������� �������'), 'action_id'=>5);


$core->modules->add_controller('list', 'add', 'save', 'del', 'edit', 'show');
...
$core->modules->this['tpl']['name'] = ($core->site_type == 3)? false : 'main.html';
