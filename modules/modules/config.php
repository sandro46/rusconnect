...
$core->modules->this['menu'][]= array('controller' => 'list' , 'name'=>'Список модулей', 'action_id'=>1);
$core->modules->this['menu'][]= array('controller' => 'add' , 'name'=>'Добавить модуль', 'action_id'=>5);
$core->modules->this['menu'][]= array('controller' => 'list_modules' , 'name'=>'Установка модулей', 'action_id'=>1);
$core->modules->this['menu'][]= array('controller' => 'updates' , 'name'=>'Обновления', 'action_id'=>1);

$core->modules->this['controllers_path']= '/controllers/';


$core->modules->add_controller('list', 'add', 'del', 'edit', 'save', 'list_modules', 'install', 'uninstall', 'updates');
