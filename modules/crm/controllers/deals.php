...
$core->ajax->register($api, 'getDeals', 1);
$core->ajax->register($buh, 'autocomplete', 1);
$core->ajax->register($api, 'autocomplete', 1);
$core->ajax->register($api, 'saveDeal', 1);
$core->ajax->register($api, 'getDealMap', 1);
$core->ajax->register($api, 'updateDealMap', 1);
...
$core->ajax->register($api, 'deleteCompany', 1);
// котнакты
$core->ajax->register($api, 'getContacts', 1); 
$core->ajax->register($api, 'saveContact', 1); 
$core->ajax->register($api, 'getCRMuserInfo', 1);
$core->ajax->register($api, 'getContactInfo', 1);
$core->ajax->register($api, 'deleteContact', 1);
