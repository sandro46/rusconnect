...
// компании
//$core->ajax->register($buh, 'autocomplete', 1);
//$core->ajax->register($api, 'getList', 1);
//$core->ajax->register($api, 'saveCupon', 1);
$core->ajax->register($api, 'getList', 1);
$core->ajax->register($api, 'deleteRequest', 1);
$core->ajax->register($api, 'saveCompany', 1);
$core->ajax->register($api, 'createPartnerAccountFromExistCompany', 1);



$core->ajax->register($buh, 'getCompanyInfo', 1);
$core->ajax->register($buh, 'deleteCompany', 1);
...
$core->tpl->assign('cityList',$api->getCityList());
//$core->tpl->assign('contragents',$buh->getContragentsReference());
