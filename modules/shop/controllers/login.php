...
$controller->cached();
$controller->tpl = 'login.html';
if(!empty($_GET['op'])) {
    if($_GET['op'] == 'register') {
        $controller->tpl = 'register.html';
    } else if($_GET['op'] == 'remember') {
        $controller->tpl = 'remember.html';
    }
}

$core->title =  $core->shop->shopInfo['name'].' - Авторизация';
