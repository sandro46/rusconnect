...
$controller->cached();
$controller->tpl = 'products_main.html';

$core->title = 'M-cms control panel - '.$core->modules->this['describe'].'';


$controller->load('client.shop.php');
$api = new yandex_market();
$core->header();
echo '<html><head><meta content="text/html; charset=UTF-8" http-equiv="Content-Type"></head><body>';

//print_r($api->getCatList(90402));
//print_r($api->getVendors(90404, 105384));
//print_r($api->getFeatures(90404, 105384));

//$api->updateCategories();
$api->updateVendors();
//$api->updateFeature();

//<script type="text/javascript">mvc.map
echo 'sdfsdfsd';
die();


//$core->tpl->assign('ppage',(isset($_GET['page'])? $_GET['page'] : 0));
//$core->tpl->assign('contragents',$api->getContragentsReference());
//$core->tpl->assign('storelist',$api->get_store_list());
