...
$controller->tpl = 'compare.html';
$core->tpl->assign('show_sidebar', false);
$core->tpl->assign('show_content_container', false);

if(!count($_SESSION['compare'])) {
    $core->tpl->assign('compare_clear', true);
} else {
    $core->tpl->assign('compareFeatures', $core->shop->getCompareFeatures());
    $core->tpl->assign('compareProducts', $core->shop->getCompareFeaturesProducts());
}
