...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (hasOptions) {
            ...
            if (typeof options.showYearInCalTop == 'boolean') {
                this.showYearInCalTop = options.showYearInCalTop;
            }
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            html += '<th colspan="5" style="width: auto">' + this.locale.monthNames[calendar[1][1].getMonth()];
            
            if(this.showYearInCalTop) {
       		     html += calendar[1][1].toString(" yyyy");
       	    }
