      ...
      , methods = {
        init: function (opt) {
          this.each(function () {
              ...
              $spanLeft = $('<span></span>').addClass("labelLeft").text(options.label.enabled === undefined ? "ВКЛ" : options.label.enabled);
              $spanRight = $('<span></span>').addClass("labelRight").text(options.label.disabled === undefined ? "ВЫКЛ " : options.label.disabled);
