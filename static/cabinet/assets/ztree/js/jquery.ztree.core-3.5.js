...
(function($){
	...
	_initNode = function(setting, level, n, parentNode, isFirstNode, isLastNode, openFlag) {
		...
		///////////////////////////////////////
		if(typeof(n.childs) != 'undefined' && n.childs > 0) {
			n.isParent = true;
			n.zAsync = false;
		}
	...
	view = {
		...
		asyncNode: function(setting, node, isSilent, callback) {
			...
			if(typeof(setting.async.func) == 'function') {
				//console.log(node, setting, spKey, pKey);
				
				setting.async.func(node.id,function(newNodes) {
