<?php
	...
	define('IS_DEV', 0);
	define('EDIT', ((!empty($_COOKIE['edit']) && $_COOKIE['edit'])? true : false));

	header("X-Frame-Options:sameorigin");

	/*if($_SERVER['REMOTE_ADDR'] == '185.48.36.17')*/ define('MAINTENANCE', false); /*else define('MAINTENANCE', true);*/
    ...
    # Основная база данных (дополнителные баззы указываются с другим ключем)
    $config['db_site']['dbname']      = 'rusconnect';
    $config['db_site']['dbhostname']  = 'localhost';
    $config['db_site']['dbusername']  = 'root';
    $config['db_site']['dbpass']      = '';
    ...
    $config['perfomance']['cache_sites'] = 0;  // кэшировать информацию о сайтах 1 - в сессии, false - не кеширвоать
    $config['perfomance']['cache_theme'] = 0;  // кэшировать информацию о темах 1 - в сессии, false - не кеширвоать
    ...
    #Интеграция
    $config['unisender']['apikey'] = '59w34i5s84ueht4c66txrd4hwwd7b5tw3xjcz3ra';
    $config['1csql']['ip'] = '91.143.41.13';
    $config['1csql']['login'] = 'sa';
    $config['1csql']['pass'] = 'Rusconnect2015';
    $config['1csql']['dbname'] = 'db2014';

    $config['1cServices'] = array(
        'price' => array(
            'url' => 'https://1c.rusconnect.ru/trade/ws/PriceAndQuantityQuery?wsdl&v=0.2',
            'login' => 'ws',
            'password' => 'rusconws',
